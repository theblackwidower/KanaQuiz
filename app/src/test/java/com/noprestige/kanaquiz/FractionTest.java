...
public class FractionTest
{
    ...
    public void toStringTest() throws Exception
    {
        ...
        assertEquals(new Fraction(5f / 10f).toString(), "½");
        ...
        assertEquals(new Fraction(15f / 10f).toString(), "1½");
        ...
        assertEquals(new Fraction(3f / 12f).toString(), "¼");
        ...
        assertEquals(new Fraction(9f / 12f).toString(), "¾");
        ...
        assertEquals(new Fraction(15f / 12f).toString(), "1¼");
        ...
        assertEquals(new Fraction(21f / 12f).toString(), "1¾");
